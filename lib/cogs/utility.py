...
class Utility(Cog):
    ...
    async def info(self, ctx, *user):
        ...
        embed.set_author(name="TechnoShip123",
                         url="https://avatars.githubusercontent.com/u/75491816?s=460&u=f9d8a3cb1a09ed5cc5e918f04ff0e477bc0fadb9&v=4",
    ...
    @command(name="remind", aliases=["reminder, remindme"],
             help="This command allows you to set a remind from 5 minutes to 7 days! Specify your value like 5m for 5 minutes.")
